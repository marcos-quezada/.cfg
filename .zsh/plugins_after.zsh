...
if [[ "$(tput colors)" == "256" ]]; then
    ...
    ZSH_HIGHLIGHT_STYLES[alias]=fg=006,bold
    ZSH_HIGHLIGHT_STYLES[builtin]=fg=006,bold
    ZSH_HIGHLIGHT_STYLES[function]=fg=006,bold
    ZSH_HIGHLIGHT_STYLES[command]=fg=006,bold
    ZSH_HIGHLIGHT_STYLES[precommand]=fg=006,underline
    ...
    ZSH_HIGHLIGHT_STYLES[single-hyphen-option]=fg=045,bold
    ZSH_HIGHLIGHT_STYLES[double-hyphen-option]=fg=045,bold
