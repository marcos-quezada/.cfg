...
if [[ "$(tput colors)" == "256" ]]; then
    ...
    ZSH_HIGHLIGHT_STYLES[alias]=fg=045,bold
    ZSH_HIGHLIGHT_STYLES[builtin]=fg=045,bold
    ZSH_HIGHLIGHT_STYLES[function]=fg=045,bold
    ZSH_HIGHLIGHT_STYLES[command]=fg=045,bold
    ZSH_HIGHLIGHT_STYLES[precommand]=fg=045,underline
    ...
    ZSH_HIGHLIGHT_STYLES[single-hyphen-option]=fg=006,bold
    ZSH_HIGHLIGHT_STYLES[double-hyphen-option]=fg=006,bold
